...
export default function EgitmenOgrenmeDetay({ user }) {
  ...
  const loadTraining = async () => {
    try {
      ...
      setTraining({
        ...
        description:
          data.description || data.aciklama || "Eğitim açıklaması bulunamadı.",
      ...
      console.log("Eğitmen eğitim detay yükleme hatası:", error.message);
      setTraining(null);
    } finally {
      setLoading(false);
    }
  ...
  const goToLesson = (moduleId) => {
    navigate(`/egitmen/ogrenme-ders/${training.id}/${moduleId}`);
  };

  const goToQuiz = () => {
    navigate(`/egitmen/quiz/${training.id}`, {
      state: {
              ...
              <div className="relative flex gap-8 items-center">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-7">
                    ...
                    <MiniInfo
                      icon={Star}
                      title="Kazanılacak XP"
                      value={`${training.xp || 50} XP`}
                      red
                    />
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-slate-400 font-bold text-sm mt-1">
                    Modülleri kullanıcı deneyimiyle aynı akışta tamamla
                  </p>
                </div>
            ...
            {training.resources?.length > 0 && (
              <div className="bg-white border border-slate-200 rounded-[2rem] p-7 shadow-sm">
                <div className="mb-5">
                  ...
                  <p className="text-slate-400 font-bold text-sm mt-1">
                    Doküman, PDF, metin ve ek kaynaklar
                  </p>
                </div>
          ...
          <aside className="space-y-6 xl:sticky xl:top-28 h-fit">
            ...
            >
              <div className="flex items-center justify-between gap-4">
                ...
                {certificateReady && (
                  <button onClick={() => navigate("/egitmen/sertifikalar")}>
